...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wxfaa5ad2148cdc8da'),         // AppID
    'secret'  => env('WECHAT_SECRET', '874a8533c93f3f7dd50b1e142c0517cf'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'laidutoken'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', '5HJQnMjkcBy2xxe06qLYM4OSbDSMgpC6fPdrs9SScoC'),                    // EncodingAESKey
